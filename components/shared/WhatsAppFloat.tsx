...
export function WhatsAppFloat() {
  return (
    ...
    >
      ...
      <span className="animate-pulse-ring flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_8px_30px_-6px_rgba(37,211,102,0.7)] transition-transform group-hover:scale-105">
        <svg
          viewBox="0 0 24 24"
          width="28"
          height="28"
